 ...
 * @author sumit
 */
public class issuedBookInfo extends javax.swing.JFrame {

    /**
     * Creates new form ViewBook
     * @throws java.sql.SQLException
     */
    public issuedBookInfo() throws SQLException {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("D:\\KcmitLLibrary\\icon\\issued.png")); // NOI18N
        ...
        BookIDRadio.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        UserIDRadio.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchActionPerformed
      ...
      //  String Column[]=null;
        ...
        else
        {
				...
				JOptionPane.showMessageDialog(issuedBookInfo.this, "Select Name or Author","No Selection!", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(issuedBookInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new issuedBookInfo().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(issuedBookInfo.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
