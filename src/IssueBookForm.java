...
public class IssueBookForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon("D:\\KcmitLLibrary\\icon\\issuebookbtn.png")); // NOI18N
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon("D:\\KcmitLLibrary\\icon\\form.png")); // NOI18N
        jLabel9.setText("Book Issue Form");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(TransactBookDb.BookValidate(BookID.getText()) && TransactBookDb.UserValidate(UserID.getText()))
        {
          
            if(TransactBookDb.Check(UserIDV)==0)
            ...
            {
            if(TransactBookDb.IssueBook(BookIDV, UserIDV, IFDate, RFDate)!=0)
            {
        ...
        {    if(TransactBookDb.UserValidate(UserID.getText()))
                ...
                if(TransactBookDb.BookValidate(BookID.getText()))
